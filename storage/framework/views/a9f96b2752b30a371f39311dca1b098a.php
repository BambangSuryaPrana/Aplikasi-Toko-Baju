    ...
    <div class="col-md-10">
        <div class="card-modern">
            <div class="card-header" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); color: white; padding: 1.5rem;">
                <h5 class="mb-0"><i class="bi bi-pencil"></i> Edit Produk: <?php echo e($product->name); ?></h5>
            </div>
...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          style="border-radius: 10px; padding: 12px;"><?php echo e(old('description', $product->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="size" name="size" required
                                            style="border-radius: 10px; padding: 12px;">
                                        <?php $__currentLoopData = ['S', 'M', 'L', 'XL', 'XXL']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($size); ?>" <?php echo e(old('size', $product->size) == $size ? 'selected' : ''); ?>><?php echo e($size); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="color" name="color" value="<?php echo e(old('color', $product->color)); ?>" required
                                           style="border-radius: 10px; padding: 12px;">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="price" name="price" value="<?php echo e(old('price', $product->price)); ?>" min="0" required
                                       style="border-radius: 10px; padding: 12px;">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" 
                                       <?php echo e(old('is_active', $product->is_active) ? 'checked' : ''); ?> style="width: 20px; height: 20px;">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="image-upload-wrapper">
                                    ...
                                    " onclick="document.getElementById('image').click()">
                                        <div class="text-center text-muted" id="uploadPlaceholder" style="<?php echo e($product->image ? 'display: none;' : ''); ?>">
                                            <i class="bi bi-cloud-arrow-up" style="font-size: 3rem;"></i>
                                            <p class="mb-0 mt-2">Klik untuk upload gambar</p>
                                            <small>JPG, PNG, GIF, WEBP (Max 5MB)</small>
                                        </div>
                                        <img id="previewImg" src="<?php echo e($product->image_url); ?>" alt="Preview" style="
                                            max-width: 100%;
                                            max-height: 100%;
                                            object-fit: contain;
                                            <?php echo e($product->image ? '' : 'display: none;'); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('admin.products.index')); ?>" class="btn btn-modern btn-modern-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Aplikasi\laragon\www\akari-store\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>