...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          style="border-radius: 10px; padding: 12px;"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="size" name="size" required
                                        ...
                                        <?php $__currentLoopData = ['S', 'M', 'L', 'XL', 'XXL']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($size); ?>" <?php echo e(old('size') == $size ? 'selected' : ''); ?>><?php echo e($size); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="color" name="color" value="<?php echo e(old('color')); ?>" required
                                           style="border-radius: 10px; padding: 12px;">
...
unset($__errorArgs, $__bag); ?>" 
                                           id="stock" name="stock" value="<?php echo e(old('stock', 0)); ?>" min="0" required
                                           style="border-radius: 10px; padding: 12px;">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" 
                                       <?php echo e(old('is_active', true) ? 'checked' : ''); ?> style="width: 20px; height: 20px;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Aplikasi\laragon\www\akari-store\resources\views/admin/products/create.blade.php ENDPATH**/ ?>