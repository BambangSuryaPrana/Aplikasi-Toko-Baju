...
unset($__errorArgs, $__bag); ?>" 
                               id="store_name" name="store_name" value="<?php echo e(old('store_name', $settings->store_name ?? 'Toko Baju')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                  id="store_address" name="store_address" rows="2"><?php echo e(old('store_address', $settings->store_address ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control <?php $__errorArgs = ['store_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   id="store_phone" name="store_phone" value="<?php echo e(old('store_phone', $settings->store_phone ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" class="form-control <?php $__errorArgs = ['store_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   id="store_email" name="store_email" value="<?php echo e(old('store_email', $settings->store_email ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php $__errorArgs = ['promo_text'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               id="promo_text" name="promo_text" value="<?php echo e(old('promo_text', $settings->promo_text ?? '')); ?>">
                        <small class="text-muted">Ditampilkan di footer website.</small>
                        <?php $__errorArgs = ['promo_text'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" 
                               ...
                               value="<?php echo e(old('low_stock_threshold', $settings->low_stock_threshold ?? 10)); ?>" min="1">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Aplikasi\laragon\www\akari-store\resources\views/admin/settings/edit.blade.php ENDPATH**/ ?>